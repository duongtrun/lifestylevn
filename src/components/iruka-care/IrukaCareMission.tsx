...
const missionData = [
  {
    ...
    label: 'Tầm nhìn',
    icon: Eye,
    imageDesktop: '/img_iruka_care/irukacare_tam_nhin.webp',
    imageMobile: '/img_iruka_care/irukacare_tam_nhin_mobile.webp',
    heading: 'TẦM NHÌN',
...
`,
  ...
  },
  {
    ...
    label: 'Sứ mệnh',
    icon: Compass,
    imageDesktop: '/img_iruka_care/irukacare_su_menh.webp',
    imageMobile: '/img_iruka_care/irukacare_su_menh_mobile.webp',
    heading: 'SỨ MỆNH',
  ...
  },
  {
    ...
    label: 'Cam kết',
    icon: ShieldCheck,
    imageDesktop: '/img_iruka_care/irukacare_cam_ket.webp',
    imageMobile: '/img_iruka_care/irukacare_cam_ket_mobile.webp',
    heading: 'CAM KẾT',
