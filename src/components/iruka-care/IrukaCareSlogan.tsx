    ...
    <section className="w-full bg-white py-16 md:py-24 flex justify-center items-center overflow-hidden">
      <div className="relative w-full max-w-[900px] px-4 flex justify-center items-center min-h-[300px] md:min-h-[400px]">
        ...
        <motion.div 
          ...
          className="relative z-10 flex flex-col items-center text-center px-6 sm:px-10 md:px-24 py-12 md:py-16 mt-4"
        >
          ...
          {/* Tiêu đề */}
          <h2 className="text-sm sm:text-base md:text-xl font-bold text-[#333333] mb-4">
            iruKa Care – An toàn chạm đến từng khoảnh khắc
          </h2>

          {/* Lời hứa */}
          <p className="text-xs sm:text-sm md:text-base text-[#333333] max-w-[280px] sm:max-w-[400px] md:max-w-[650px] leading-relaxed md:leading-loose mb-2">
          ...
          <p className="text-xs sm:text-sm md:text-base text-[#333333] max-w-[280px] sm:max-w-[400px] md:max-w-[650px] leading-relaxed md:leading-loose font-medium">
