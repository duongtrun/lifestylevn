...
export default function NewsSection({ posts }: NewsSectionProps) {
  ...
  // Nếu không có bài viết nào, ẩn hoàn toàn section
              ...
              return (
                ...
                >
                  ...
                  >
                    ...
                    <div className="absolute inset-0 bg-gradient-to-t from-black/95 via-black/40 to-transparent opacity-95 group-hover:opacity-100 transition-opacity duration-300 z-10" />
